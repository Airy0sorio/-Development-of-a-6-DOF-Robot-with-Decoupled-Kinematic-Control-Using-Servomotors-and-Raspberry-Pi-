...
Mas informacion en la sección 4.1 del pdf adjunto
[documento PDF](./Recursos_Adicionales/Análisis_Cinemático_de_un_Robot_de_6_GDL.pdf).
...
Mas informacion en la sección 4.2 del pdf adjunto
[documento PDF](./Recursos_Adicionales/Análisis_Cinemático_de_un_Robot_de_6_GDL.pdf).
...
- **Bularka, Szilard**, **Szabo, Roland**, **Otesteanu, Marius**, & **Babaita, Mircea**. (2018). Robotic Arm Control with Hand Movement Gestures. *Conference Proceedings of the 2018 41st International Conference on Telecommunications and Signal Processing (TSP)*, 1-5. [doi:10.1109/TSP.2018.8441341](https://doi.org/10.1109/TSP.2018.8441341)

- **Zhu, Jiude**, **Pei, Yijian**, **Liu, Yunkai**, & **Gao, Donglin**. (2020). Design and Implementation of Dual-Arm Mobile Robot System Based on Wireless Transmission. *Conference Proceedings of the 2020 5th International Conference on Computer and Communication Systems (ICCCS)*, 757-760. [doi:10.1109/ICCCS49078.2020.9118454](https://doi.org/10.1109/ICCCS49078.2020.9118454)

- **Yuen, Man-Ching**, **Chan, Ka Kei**, & **Li, Kwok Shing**. (2021). Mobile App Controlled Modular Combat Robot for STEM Education. *Conference Proceedings of the 2021 International Conference on COMmunication Systems & NETworkS (COMSNETS)*, 64-68. [doi:10.1109/COMSNETS51098.2021.9352927](https://doi.org/10.1109/COMSNETS51098.2021.9352927)

- **Premkumar, Keerthi**, & **Gerard Joe Nigel, K**. (2015). Smart phone based robotic arm control using raspberry pi, android and Wi-Fi. *Conference Proceedings of the 2015 International Conference on Innovations in Information, Embedded and Communication Systems (ICIIECS)*, 1-3. [doi:10.1109/ICIIECS.2015.7192973](https://doi.org/10.1109/ICIIECS.2015.7192973)

- **Sharma, Shivam**, **Sahai, Shashwat**, **Joshi, Jaisal**, & **Hema, N**. (2018). Stage-wise Development of a Remote Controlled Robotic Arm. *Conference Proceedings of the 2018 Fifth International Conference on Parallel, Distributed and Grid Computing (PDGC)*, 364-367. [doi:10.1109/PDGC.2018.8745871](https://doi.org/10.1109/PDGC.2018.8745871)

- **Singh, Gaurav**, **Singh, Ashirwad Kumar**, **Yadav, Anurag**, **Bhardwaj, Indu**, & **Chauhan, Usha**. (2020). IoT developed Wi-Fi Controlled Rover With Robotic Arm Using NodeMCU. *Conference Proceedings of the 2020 2nd International Conference on Advances in Computing, Communication Control and Networking (ICACCCN)*, 497-501. [doi:10.1109/ICACCCN51052.2020.9362956](https://doi.org/10.1109/ICACCCN51052.2020.9362956)

- **Kim, Soohyun**, **Mun, Hyunsu**, & **Lee, Youngseok**. (2020). Automatic Mobile App Speed Measurement with Robot. *Conference Proceedings of the 2020 21st Asia-Pacific Network Operations and Management Symposium (APNOMS)*, 365-368. [doi:10.23919/APNOMS50412.2020.9236980](https://doi.org/10.23919/APNOMS50412.2020.9236980)

- **Spong, M. W.**, **Hutchinson, Seth**, & **Vidyasagar, M**. (2006). *Robot Dynamics and Control*. Wiley.

- **Craig, J. J.** (2005). *Introduction to Robotics: Mechanics and Control* (3rd ed.). Prentice-Hall.

- **Barrientos, A.**, **Peñin, L. F.**, **Balaguer, C.**, & **Aracil, R.** (1996). *Fundamentos de Robótica* (Primera edición en español). McGraw-Hill.

- **Reyes Cortés, Fernando**. (2008). *Robótica: Control de Robots Manipuladores*. Editorial AlfaOmega.
